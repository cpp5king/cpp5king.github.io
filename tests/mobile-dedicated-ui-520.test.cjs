...
test('5.2 dedicated mobile flow is loaded and cached offline',()=>{
  ...
  assert.match(html,/src\/mobile-inspection-flow\.js\?v=5\.2\.4/);
  assert.match(html,/src\/mobile-wizard\.js\?v=5\.2\.4/);
  assert.match(html,/src\/styles\.css\?v=5\.2\.4/);
  assert.match(html,/src\/sentence-app\.js\?v=5\.2\.4/);
