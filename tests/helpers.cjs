...
function runtime() {
  ...
  ["data/texts/noise-common.js","data/texts/noise-templates.js","data/texts/noise-main.js","data/texts/noise-article8.js","data/texts/noise-article9.js","data/texts/noise-neighbor.js","data/texts/noise-ui.js","data/texts/water-main.js","data/texts/water-field.js","src/noise-format.js","data/texts/noise-documents.js", 'src/noise-text.js', 'data/templates/catalog.js', 'data/rules/noise-article8.js', 'data/rules/noise-article9.js','src/noise-zone.js','src/noise-main.js','src/noise-method-guidance.js','src/noise-composite.js','src/noise-boundary.js','src/noise-priority-routing.js','data/water-rules.js','data/water-measure-rules.js','src/water-measure-law.js','src/water-law-versions.js','src/water-facts.js','src/water-rule-engine.js','src/water-law.js','src/water-industry.js','src/water-workflow.js','src/water-dependencies.js','src/water-assessment.js','src/water-documents.js','src/water-main.js','src/water-field.js', 'src/draft-engine.js', 'src/template-loader.js', 'src/case-file.js', 'src/case-session.js', 'src/choice-controls.js', 'src/ui-profile.js'].forEach(run);
