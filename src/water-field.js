(function(root){
  ...
  function resetChange(previous={},current={}){
    ...
    if(previous.fieldSourceMode!==current.fieldSourceMode)clear(['fieldUnknownWaterObserved','fieldUnknownWaterSigns','fieldUnknownFlowDirectionConfirmed','fieldUnknownUpstreamTraceStatus','fieldUnknownBranchStatus','fieldUnknownOutletFound','fieldUnknownSourceConnectionConfirmed','waterSubjectType','waterSubjectConfirmed','waterIndustryCheckMode','waterIndustryType','fieldOperationStatus','fieldProcessObserved','fieldWaterUseObserved','waterMatterType','waterWastewaterStatus','waterSourceTypes','fieldCollectionStatus','waterTreatmentFacilityApplicable','waterTreatmentOperatingNormally','fieldRouteTraced','waterDestination','waterSurfaceType','waterSurfaceWaterConfirmed','waterDrainageFunctionConfirmed','waterDownstreamConfirmed','waterDrainageConnectionConfirmed','waterActualDischarge','waterDischargePermit','waterDumpingConfirmed','waterControlZoneConfirmed','waterDesignatedWaterRangeConfirmed','waterArticle28Scenario','waterTransportStorageEquipmentConfirmed','waterLeakCause','waterLeakRiskToWaterBodyConfirmed','waterMaintenancePreventionTaken','waterLeakPollutedWaterBody','waterSevereHazardRiskConfirmed','waterEmergencyActionTaken','waterThreeHourNotice','waterSampleTaken','waterSampleRepresentative','waterSampleBeforeReceivingWater','waterLabResultAvailable','waterEffluentExceeded','waterEvidenceTypes','waterInvestigationComplete']);
    ...
    if(previous.waterLivestockFertilizerUse!==current.waterLivestockFertilizerUse)clear(['waterLivestockFertilizerPlanApproved','waterLivestockFertilizerMatchesPlan']);
    if(previous.waterSubjectConfirmed!==current.waterSubjectConfirmed)clear(['waterIndustryCheckMode','waterIndustryType','waterIndustryRainProtectionStatus','waterIndustrySedimentationBasinPresent','waterIndustrySedimentationCapacityCompliant','waterIndustrySedimentationFreeboardCompliant','waterIndustrySedimentationImpermeableCompliant','waterIndustryMaintenanceRecordsCompliant','waterConstructionReductionPlanApprovedBeforeWork','waterConstructionImplementedApprovedPlan','waterLivestockFertilizerUse','waterLivestockFertilizerPlanApproved','waterLivestockFertilizerMatchesPlan','fieldOperationStatus','fieldProcessObserved','fieldWaterUseObserved','waterMatterType','waterWastewaterStatus','waterSourceTypes','fieldCollectionStatus','waterTreatmentFacilityApplicable','waterTreatmentOperatingNormally','fieldRouteTraced','waterDestination','waterSurfaceType','waterSurfaceWaterConfirmed','waterDrainageFunctionConfirmed','waterDownstreamConfirmed','waterDrainageConnectionConfirmed','waterActualDischarge','waterDischargePermit','waterDumpingConfirmed','waterControlZoneConfirmed','waterDesignatedWaterRangeConfirmed','waterArticle28Scenario','waterTransportStorageEquipmentConfirmed','waterLeakCause','waterLeakRiskToWaterBodyConfirmed','waterMaintenancePreventionTaken','waterLeakPollutedWaterBody','waterSevereHazardRiskConfirmed','waterEmergencyActionTaken','waterThreeHourNotice','waterSampleTaken','waterSampleRepresentative','waterSampleBeforeReceivingWater','waterLabResultAvailable','waterEffluentExceeded','waterEvidenceTypes','waterInvestigationComplete']);
    ...
    if(previous.fieldCollectionStatus!==current.fieldCollectionStatus)clear(['waterTreatmentFacilityApplicable','waterTreatmentOperatingNormally','fieldRouteTraced','waterDestination','waterActualDischarge','waterEvidenceTypes','waterInvestigationComplete']);
    if(previous.waterTreatmentFacilityApplicable!==current.waterTreatmentFacilityApplicable)clear(['waterTreatmentOperatingNormally','fieldRouteTraced','waterDestination','waterActualDischarge','waterEvidenceTypes','waterInvestigationComplete']);
    ...
    if(previous.waterSurfaceWaterConfirmed!==current.waterSurfaceWaterConfirmed)clear(['waterDischargePermit','waterSampleTaken','waterSampleRepresentative','waterSampleBeforeReceivingWater','waterLabResultAvailable','waterEffluentExceeded']);
    ...
    if(previous.waterControlZoneConfirmed!==current.waterControlZoneConfirmed&&current.waterControlZoneConfirmed==='no')clear(['waterDesignatedWaterRangeConfirmed']);
    ...
    if(previous.waterTransportStorageEquipmentConfirmed!==current.waterTransportStorageEquipmentConfirmed)clear(['waterLeakCause','waterLeakRiskToWaterBodyConfirmed','waterMaintenancePreventionTaken','waterLeakPollutedWaterBody','waterEmergencyActionTaken','waterThreeHourNotice']);
    if(previous.waterLeakCause!==current.waterLeakCause)clear(['waterLeakRiskToWaterBodyConfirmed','waterMaintenancePreventionTaken','waterLeakPollutedWaterBody','waterEmergencyActionTaken','waterThreeHourNotice']);
    if(previous.waterLeakRiskToWaterBodyConfirmed!==current.waterLeakRiskToWaterBodyConfirmed)clear(['waterMaintenancePreventionTaken']);
    if(previous.waterLeakPollutedWaterBody!==current.waterLeakPollutedWaterBody||previous.waterSevereHazardRiskConfirmed!==current.waterSevereHazardRiskConfirmed)clear(['waterEmergencyActionTaken','waterThreeHourNotice']);
    if(previous.waterSampleTaken!==current.waterSampleTaken)clear(['waterSampleRepresentative','waterSampleBeforeReceivingWater','waterLabResultAvailable','waterEffluentExceeded']);
    if(previous.waterSampleRepresentative!==current.waterSampleRepresentative||previous.waterSampleBeforeReceivingWater!==current.waterSampleBeforeReceivingWater)clear(['waterLabResultAvailable','waterEffluentExceeded']);
    if(previous.waterLabResultAvailable!==current.waterLabResultAvailable)clear(['waterEffluentExceeded']);
    if(JSON.stringify(previous.waterEvidenceTypes||[])!==JSON.stringify(current.waterEvidenceTypes||[]))clear(['waterInvestigationComplete']);
    return root.WaterDependencies?.resetChange ? root.WaterDependencies.resetChange(previous,next) : next;
  }
