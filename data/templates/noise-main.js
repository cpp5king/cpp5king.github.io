(function(root){
  ...
  const t={
    ...
    version:'4.9-rebuild-3',moduleVersion:'4.9-rebuild-3',workflow:'noiseMain',choiceStyle:'cards',initialGate:true,
    ...
    fields:[
      computed('noiseShowA8','a8'),computed('noiseShowA8Disturbance','a8d'),computed('noiseShowA8Exception','a8e'),computed('noiseShowAfterA8','afterA8'),computed('noiseShowA6Disturbance','a6d'),
      computed('noiseShowA9','a9'),computed('noiseShowOtherFacility','other'),computed('noiseShowMeasure','measure'),computed('noiseShowFull','full'),computed('noiseShowFullPoint','fullPoint'),computed('noiseShowWeather','weather'),
      computed('noiseShowGeneralMethod','generalMethod'),computed('noiseShowSpeakerMode','speakerMode'),computed('noiseShowFullAssessment','fullAssessment'),computed('noiseShowConstructionFull','constructionFull'),
      computed('noiseShowLow','low'),computed('noiseShowConstructionLmax','lmax'),computed('noiseShowBgFull','bgfull'),computed('noiseShowBgLmax','bglmax'),computed('noiseShowBgLow','bglow'),
