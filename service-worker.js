importScripts('./data/law-offline-assets.js?v=5.2.8');
const PROVENANCE='PP-IA-41-7F3C9A21';
const VERSION='5.2.8';
const CACHE_REVISION='noise-refactor-test-7';
const CACHE_NAME='inspection-assistant-5.2.8-pp-7f3c9a21-'+CACHE_REVISION;
const V='?v='+VERSION;
