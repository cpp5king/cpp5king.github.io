(function(root){
  ...
  const template={
    ...
    fields:[
      ...
      computed('waterMeasureRulePackVersionText',T.measureRulePackVersion,{display:true}),
      computed('waterMeasureLawVersionText',T.measureLawVersion,{display:true}),
      computed('waterPermitRulePackVersionText',T.permitRulePackVersion,{display:true}),
      computed('waterPermitLawVersionText',T.permitLawVersion,{display:true}),
      computed('waterStandardRulePackVersionText',T.standardRulePackVersion,{display:true}),
      computed('waterStandardLawVersionText',T.standardLawVersion,{display:true}),
      computed('waterStandardRouteText',T.standardRoute,{display:true}),
      computed('waterLocalRulePackVersionText',T.localRulePackVersion,{display:true}),
      computed('waterLocalRuleStatusText',T.localRuleStatus,{display:true}),
